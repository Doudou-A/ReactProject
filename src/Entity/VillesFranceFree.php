 ...
 * VillesFranceFree
 *
 * @ORM\Table(name="villes_france_free", uniqueConstraints={@ORM\UniqueConstraint(name="ville_slug", columns={"ville_slug"}), @ORM\UniqueConstraint(name="ville_code_commune_2", columns={"ville_code_commune"})}, indexes={@ORM\Index(name="ville_longitude_latitude_deg", columns={"ville_longitude_deg", "ville_latitude_deg"}), @ORM\Index(name="ville_nom_soundex", columns={"ville_nom_soundex"}), @ORM\Index(name="ville_population_2010", columns={"ville_population_2010"}), @ORM\Index(name="ville_nom", columns={"ville_nom"}), @ORM\Index(name="ville_code_commune", columns={"ville_code_commune"}), @ORM\Index(name="ville_nom_metaphone", columns={"ville_nom_metaphone"}), @ORM\Index(name="ville_nom_simple", columns={"ville_nom_simple"}), @ORM\Index(name="ville_departement", columns={"ville_departement"}), @ORM\Index(name="ville_nom_reel", columns={"ville_nom_reel"}), @ORM\Index(name="ville_code_postal", columns={"ville_code_postal"})})
 * @ORM\Entity
 */
